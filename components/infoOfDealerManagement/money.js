...
function MoenyManagement(props) {
    ...
    <ContentWrapper>
      {
        <DataTable {...dataTable()}
          hasSearch={false}
                   leftControl={
                     () => (
                       <h3 className="content-header-title mb-0">Danh sách tiền hàng</h3>
                     )
                   }
...
MoenyManagement.propTypes = {
  provinces: PropTypes.array,
  userId: PropTypes.number
}
MoenyManagement.defaultProps = {
  provinces: [],
};

export default MoenyManagement;
