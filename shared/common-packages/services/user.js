...
export const UserApi = {
  ...
  async getListUserAddress(id, useInternal = false, headers = {}) {
    return await request(
      'GET',
      `${Utility.getRemoteHost(useInternal)}api/user-address/get-by-user-id/${id}`,
      {},
      headers
    )
  },
  async getListUserPackage(id, useInternal = false, headers = {}) {
    return await request(
      'GET',
      `${Utility.getRemoteHost(useInternal)}api/user-package/get-by-user-id/${id}`,
      {},
      headers
    )
  },
  async getListUserReceiver(id, useInternal = false, headers = {}) {
    return await request(
      'GET',
      `${Utility.getRemoteHost(useInternal)}api/user-receiver/get-by-user-id/${id}`,
      {},
      headers
    )
  },
